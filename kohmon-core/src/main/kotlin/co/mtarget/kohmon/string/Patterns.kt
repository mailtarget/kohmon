...
object Patterns {
    ...
    private const val DOMAIN_NAME_STR = "($HOST_NAME|$IP_ADDRESS_PATTERN)"
    ...
    fun concatGroups(matcher: Matcher): String {
        val b = StringBuilder()
        val numGroups: Int = matcher.groupCount()
        for (i in 1..numGroups) {
            val s: String = matcher.group(i)
            b.append(s)
        }
        return b.toString()
    }
    ...
    fun digitsAndPlusOnly(matcher: Matcher): String {
        ...
        val matchingRegion: String = matcher.group()
        var i = 0
