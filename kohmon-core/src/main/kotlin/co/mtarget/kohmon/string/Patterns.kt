...
/**
 * Regular Expression Pattern match email
 */
...
/**
 * Regular Expression Pattern match phone
 */
const val PHONE_PATTERN = "(\\+[0-9]+[\\- \\.]*)?(\\([0-9]+\\)[\\- \\.]*)?([0-9][0-9\\- \\.]+[0-9])"

/**
 * Regular Expression Pattern match ip address
 */
...
private const val RELAXED_DOMAIN_NAME =
    "(?:(?:$IRI_LABEL(?:\\.(?=\\S))?)+|$IP_ADDRESS_PATTERN)"
/**
 ...
 * @hide
 */
const val AUTOLINK_EMAIL_ADDRESS = "($WORD_BOUNDARY(?:$EMAIL_ADDRESS_LOCAL_PART@$EMAIL_ADDRESS_DOMAIN)$WORD_BOUNDARY)"

const val DOMAIN_NAME = "($HOST_NAME|$IP_ADDRESS_PATTERN)"
 ...
 */
const val WEB_URL = "(((?:$PROTOCOL(?:$USER_INFO)?)?(?:$DOMAIN_NAME)(?:$PORT_NUMBER)?)($PATH_AND_QUERY)?$WORD_BOUNDARY)"
